...
<div class="container-fluid mt-3">
	<div class="row">
		...
		<div class="carousel-inner">
			...
			<img src="{{asset('assets/img/banner1.png')}}" style="width:100%" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
			<img src="{{asset('assets/img/banner2.png')}}" style="width:100%" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
			<img src="{{asset('assets/img/banner3.png')}}" style="width:100%" class="d-block w-100" alt="...">
			</div>
		</div>
	...
	<div class="row mt-5">
		<div class="col-md-12 text-center">
		  <h1 class="text-danger mb-5" id="bo"> Tambahan </h1>
		</div>
