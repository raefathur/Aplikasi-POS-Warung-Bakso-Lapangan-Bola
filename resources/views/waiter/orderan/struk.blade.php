...
<head>
  ...
  <title>Bakso Lapangan Bola - struk</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                {{-- <img src="{{asset('assets/img/logo.png')}}" style="width: 300px;" class="mb-2"><br> --}}
                <span id="me">
  ...
  {{-- <footer class="main-footer bg-transparent mt-2">
    <div class="text-center text-secondary py-3">
      <img src="{{asset('assets/img/logo.png')}}" style="width: 100px;" class="mb-2">
    </div></div>
  </footer> --}}
